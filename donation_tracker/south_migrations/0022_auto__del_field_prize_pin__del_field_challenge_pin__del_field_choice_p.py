...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'tracker.prize': {
            ...
            'contributors': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'prizescontributed'", 'symmetrical': 'False', 'to': u"orm['tracker.Donor']"}),
        ...
        u'tracker.speedrun': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'runners': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['tracker.Donor']", 'symmetrical': 'False'}),
