...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Prize.pin'
        db.delete_column(u'tracker_prize', 'pin')

        # Deleting field 'Challenge.pin'
        db.delete_column(u'tracker_challenge', 'pin')

        # Deleting field 'Choice.pin'
        db.delete_column(u'tracker_choice', 'pin')


    def backwards(self, orm):
        # Adding field 'Prize.pin'
        db.add_column(u'tracker_prize', 'pin',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Challenge.pin'
        db.add_column(u'tracker_challenge', 'pin',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Choice.pin'
        db.add_column(u'tracker_choice', 'pin',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    models = {
        ...
        u'donation_tracker.donation': {
            ...
            'donor': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['donation_tracker.Donor']"}),
        ...
        u'donation_tracker.prize': {
            ...
            'contributors': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'prizescontributed'", 'symmetrical': 'False', 'to': u"orm['donation_tracker.Donor']"}),
        ...
        u'donation_tracker.speedrun': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'runners': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['donation_tracker.Donor']", 'symmetrical': 'False'}),
