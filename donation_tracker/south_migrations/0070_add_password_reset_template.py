...
defaultTemplateName = 'password_reset_template'
defaultEmailSubject = 'Password Reset'
defaultEmailContent = """Hello {{ user }},
...
This login link will expire either after you reset your password, or the next time you log into your account.
...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
      ...
      if not post_office_emailtemplate.objects.filter(name=defaultTemplateName).exists():
        post_office_emailtemplate.objects.create(
