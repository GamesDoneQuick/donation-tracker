...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'PrizeTicket', fields ['prize', 'donation']
        db.create_unique(u'tracker_prizeticket', ['prize_id', 'donation_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PrizeTicket', fields ['prize', 'donation']
        db.delete_unique(u'tracker_prizeticket', ['prize_id', 'donation_id'])
