...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'donation_tracker.prizecontributor': {
            'Meta': {'object_name': 'PrizeContributor'},
            'contributor': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['donation_tracker.Donor']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'donation_tracker.speedrunrunner': {
            'Meta': {'object_name': 'SpeedRunRunner'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'run': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['donation_tracker.SpeedRun']"}),
            'runner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['donation_tracker.Donor']"})
        },
