...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Donation.donor'
        raise RuntimeError("Cannot reverse this migration. 'Donation.donor' and its values cannot be restored.")
