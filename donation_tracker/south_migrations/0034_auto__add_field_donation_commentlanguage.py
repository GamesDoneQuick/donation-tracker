...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Donation.commentlanguage'
        db.add_column(u'tracker_donation', 'commentlanguage',
                      self.gf('django.db.models.fields.CharField')(default='un', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Donation.commentlanguage'
        db.delete_column(u'tracker_donation', 'commentlanguage')
