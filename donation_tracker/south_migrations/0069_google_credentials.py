...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('donation_tracker', ['FlowModel'])
        ...
        db.send_create_signal('donation_tracker', ['CredentialsModel'])


    def backwards(self, orm):
        # Deleting model 'FlowModel'
        db.delete_table(u'tracker_flowmodel')

        # Deleting model 'CredentialsModel'
        db.delete_table(u'tracker_credentialsmodel')
