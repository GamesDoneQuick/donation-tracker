...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.pendingdonationemailtemplate'
        db.add_column(u'tracker_event', 'pendingdonationemailtemplate',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['post_office.EmailTemplate'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.pendingdonationemailtemplate'
        db.delete_column(u'tracker_event', 'pendingdonationemailtemplate_id')
    ...
    models = {
        ...
        'donation_tracker.event': {
            ...
            'pendingdonationemailtemplate': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['post_office.EmailTemplate']", 'null': 'True', 'on_delete': 'models.PROTECT', 'blank': 'True'}),
