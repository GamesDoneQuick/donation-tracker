...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PrizeWinner.pendingcount'
        db.add_column(u'tracker_prizewinner', 'pendingcount',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'PrizeWinner.acceptcount'
        db.add_column(u'tracker_prizewinner', 'acceptcount',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PrizeWinner.declinecount'
        db.add_column(u'tracker_prizewinner', 'declinecount',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PrizeWinner.sumcount'
        db.add_column(u'tracker_prizewinner', 'sumcount',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Prize.maxmultiwin'
        db.add_column(u'tracker_prize', 'maxmultiwin',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PrizeWinner.pendingcount'
        db.delete_column(u'tracker_prizewinner', 'pendingcount')

        # Deleting field 'PrizeWinner.acceptcount'
        db.delete_column(u'tracker_prizewinner', 'acceptcount')

        # Deleting field 'PrizeWinner.declinecount'
        db.delete_column(u'tracker_prizewinner', 'declinecount')

        # Deleting field 'PrizeWinner.sumcount'
        db.delete_column(u'tracker_prizewinner', 'sumcount')

        # Deleting field 'Prize.maxmultiwin'
        db.delete_column(u'tracker_prize', 'maxmultiwin')
    ...
    models = {
        ...
        'donation_tracker.credentialsmodel': {
        ...
        'donation_tracker.donorprizeentry': {
            'Meta': {'unique_together': "(('prize', 'donor'),)", 'object_name': 'DonorPrizeEntry'},
            'donor': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['donation_tracker.Donor']", 'on_delete': 'models.PROTECT'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'donation_tracker.prize': {
            ...
            'maxmultiwin': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
        ...
        'donation_tracker.prizewinner': {
            ...
            'sumcount': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
