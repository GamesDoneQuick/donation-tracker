...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Donor', fields ['email']
        db.delete_unique(u'tracker_donor', ['email'])

        # Removing unique constraint on 'Donor', fields ['alias']
        db.delete_unique(u'tracker_donor', ['alias'])


    def backwards(self, orm):
        # Adding unique constraint on 'Donor', fields ['alias']
        db.create_unique(u'tracker_donor', ['alias'])

        # Adding unique constraint on 'Donor', fields ['email']
        db.create_unique(u'tracker_donor', ['email'])
