...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Prize.shortdescription'
        db.add_column(u'tracker_prize', 'shortdescription',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Adding field 'Bid.shortdescription'
        db.add_column(u'tracker_bid', 'shortdescription',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=256, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Prize.shortdescription'
        db.delete_column(u'tracker_prize', 'shortdescription')

        # Deleting field 'Bid.shortdescription'
        db.delete_column(u'tracker_bid', 'shortdescription')
