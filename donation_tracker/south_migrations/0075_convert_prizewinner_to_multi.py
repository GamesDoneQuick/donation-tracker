...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
      ...
      for pw in orm.PrizeWinner.objects.all():
        pw.pendingcount = 0
        pw.acceptcount = 0
        pw.declinecount = 0
        if pw.acceptstate == 'PENDING':
          pw.pendingcount = 1
        elif pw.acceptstate == 'ACCEPTED':
          pw.acceptcount = 1
        elif pw.acceptstate == 'DECLINED':
          pw.declinecount = 1
        pw.save()
    ...
    def backwards(self, orm):
      ...
      for pw in orm.PrizeWinner.objects.all():
        if pw.acceptcount > 0:
          pw.acceptstate = 'ACCEPTED'
        elif pw.pendingcount > 0:
          pw.acceptstate = 'PENDING'
        elif pw.declinecount > 0:
          pw.acceptstate = 'DECLINED'
        else:
          raise Exception('Invalid PrizeWinner object detected : {0}'.format(pw.pk))
        pw.save()
