...
class Migration(DataMigration):
  def forwards(self, orm):
    ...
    for prize in orm['donation_tracker.Prize'].objects.filter(winner__isnull=False, winners=None):
      created = orm['donation_tracker.PrizeWinner'].objects.create(winner=prize.winner, prize=prize, emailsent=prize.emailsent)
      prize.winner = None
      created.save()
      prize.save()
  ...
  def backwards(self, orm):
    ...
    for prize in orm['donation_tracker.Prize'].objects.filter(~Q(winners=None)):
