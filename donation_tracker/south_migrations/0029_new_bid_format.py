...
class Migration(DataMigration):
  ...
  models = {
    ...
    u'auth.user': {
      ...
      u'donation_tracker.bid': {
          'Meta': {'ordering': "['event__name', 'speedrun__starttime', 'parent__speedrun__starttime', 'parent__parent__speedrun__starttime', 'parent__parent__name', 'parent__name', 'name']", 'unique_together': "(('event', 'speedrun', 'parent', 'name'),)", 'object_name': 'Bid', '_bases': ('mptt.models.MPTTModel',)},
  ...
  complete_apps = ['mptt', 'donation_tracker']
  symmetrical = True
