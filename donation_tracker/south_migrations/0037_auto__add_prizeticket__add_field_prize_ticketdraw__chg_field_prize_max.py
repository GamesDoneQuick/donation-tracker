...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PrizeTicket'
        db.create_table(u'tracker_prizeticket', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('prize', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tickets', to=orm['donation_tracker.Prize'])),
            ('donation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tickets', to=orm['donation_tracker.Donation'])),
            ('amount', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=2)),
        ))
        db.send_create_signal(u'donation_tracker', ['PrizeTicket'])

        # Adding field 'Prize.ticketdraw'
        db.add_column(u'tracker_prize', 'ticketdraw',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Prize.maximumbid'
        db.alter_column(u'tracker_prize', 'maximumbid', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=2))

    def backwards(self, orm):
        # Deleting model 'PrizeTicket'
        db.delete_table(u'tracker_prizeticket')

        # Deleting field 'Prize.ticketdraw'
        db.delete_column(u'tracker_prize', 'ticketdraw')


        # Changing field 'Prize.maximumbid'
        db.alter_column(u'tracker_prize', 'maximumbid', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=2))
