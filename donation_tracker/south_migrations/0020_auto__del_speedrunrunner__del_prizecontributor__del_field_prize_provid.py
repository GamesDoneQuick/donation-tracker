...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tracker_prize_contributors', (
            ...
            ('prize', models.ForeignKey(orm['donation_tracker.prize'], null=False)),
            ('donor', models.ForeignKey(orm['donation_tracker.donor'], null=False))
        ))
        ...
        db.create_table('tracker_speedrun_runners', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('speedrun', models.ForeignKey(orm['donation_tracker.speedrun'], null=False)),
            ('donor', models.ForeignKey(orm['donation_tracker.donor'], null=False))
        ))
    ...
    models = {
        ...
        'donation_tracker.prize': {
            ...
            'contributors': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'prizescontributed'", 'symmetrical': 'False', 'to': "orm['donation_tracker.Donor']"}),
        ...
        'donation_tracker.speedrun': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'runners': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['donation_tracker.Donor']", 'symmetrical': 'False'}),
