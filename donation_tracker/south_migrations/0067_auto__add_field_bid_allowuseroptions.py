...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bid.allowuseroptions'
        db.add_column(u'tracker_bid', 'allowuseroptions',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bid.allowuseroptions'
        db.delete_column(u'tracker_bid', 'allowuseroptions')
