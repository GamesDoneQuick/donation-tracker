...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'tracker_prizewinner', 'winner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['donation_tracker.Donor'], on_delete=models.PROTECT))

        # Changing field 'PrizeWinner.prize'
        db.alter_column(u'tracker_prizewinner', 'prize_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['donation_tracker.Prize'], on_delete=models.PROTECT))

        # Changing field 'DonationBid.donation'
        db.alter_column(u'tracker_donationbid', 'donation_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['donation_tracker.Donation']))

        # Changing field 'DonationBid.bid'
        db.alter_column(u'tracker_donationbid', 'bid_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['donation_tracker.Bid']))
        ...
        db.alter_column(u'tracker_prize', 'startrun_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['donation_tracker.SpeedRun']))

        # Changing field 'Prize.category'
        db.alter_column(u'tracker_prize', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['donation_tracker.PrizeCategory'], null=True, on_delete=models.PROTECT))

        # Changing field 'Prize.event'
        db.alter_column(u'tracker_prize', 'event_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['donation_tracker.Event'], on_delete=models.PROTECT))

        # Changing field 'Prize.endrun'
        db.alter_column(u'tracker_prize', 'endrun_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['donation_tracker.SpeedRun']))

        # Changing field 'BidSuggestion.bid'
        db.alter_column(u'tracker_bidsuggestion', 'bid_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['donation_tracker.Bid']))

        # Changing field 'Bid.parent'
        db.alter_column(u'tracker_bid', 'parent_id', self.gf('mptt.fields.TreeForeignKey')(null=True, on_delete=models.PROTECT, to=orm['donation_tracker.Bid']))

        # Changing field 'Bid.biddependency'
        db.alter_column(u'tracker_bid', 'biddependency_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['donation_tracker.Bid']))

        # Changing field 'Bid.speedrun'
        db.alter_column(u'tracker_bid', 'speedrun_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['donation_tracker.SpeedRun']))

        # Changing field 'Bid.event'
        db.alter_column(u'tracker_bid', 'event_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['donation_tracker.Event']))

        # Changing field 'PrizeTicket.prize'
        db.alter_column(u'tracker_prizeticket', 'prize_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['donation_tracker.Prize']))

        # Changing field 'PrizeTicket.donation'
        db.alter_column(u'tracker_prizeticket', 'donation_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['donation_tracker.Donation']))

        # Changing field 'SpeedRun.event'
        db.alter_column(u'tracker_speedrun', 'event_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['donation_tracker.Event'], on_delete=models.PROTECT))

        # Changing field 'Donation.event'
        db.alter_column(u'tracker_donation', 'event_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['donation_tracker.Event'], on_delete=models.PROTECT))

        # Changing field 'Donation.donor'
        db.alter_column(u'tracker_donation', 'donor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['donation_tracker.Donor'], null=True, on_delete=models.PROTECT))

        # Changing field 'PostbackURL.event'
        db.alter_column(u'tracker_postbackurl', 'event_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['donation_tracker.Event']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'PrizeWinner.winner'
        db.alter_column(u'tracker_prizewinner', 'winner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['donation_tracker.Donor']))

        # Changing field 'PrizeWinner.prize'
        db.alter_column(u'tracker_prizewinner', 'prize_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['donation_tracker.Prize']))

        # Changing field 'DonationBid.donation'
        db.alter_column(u'tracker_donationbid', 'donation_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['donation_tracker.Donation']))

        # Changing field 'DonationBid.bid'
        db.alter_column(u'tracker_donationbid', 'bid_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['donation_tracker.Bid']))

        # Changing field 'Prize.startrun'
        db.alter_column(u'tracker_prize', 'startrun_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['donation_tracker.SpeedRun']))

        # Changing field 'Prize.category'
        db.alter_column(u'tracker_prize', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['donation_tracker.PrizeCategory'], null=True))

        # Changing field 'Prize.event'
        db.alter_column(u'tracker_prize', 'event_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['donation_tracker.Event']))

        # Changing field 'Prize.endrun'
        db.alter_column(u'tracker_prize', 'endrun_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['donation_tracker.SpeedRun']))

        # Changing field 'BidSuggestion.bid'
        db.alter_column(u'tracker_bidsuggestion', 'bid_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['donation_tracker.Bid']))

        # Changing field 'Bid.parent'
        db.alter_column(u'tracker_bid', 'parent_id', self.gf('mptt.fields.TreeForeignKey')(null=True, to=orm['donation_tracker.Bid']))

        # Changing field 'Bid.biddependency'
        db.alter_column(u'tracker_bid', 'biddependency_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['donation_tracker.Bid']))

        # Changing field 'Bid.speedrun'
        db.alter_column(u'tracker_bid', 'speedrun_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['donation_tracker.SpeedRun']))

        # Changing field 'Bid.event'
        db.alter_column(u'tracker_bid', 'event_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['donation_tracker.Event']))

        # Changing field 'PrizeTicket.prize'
        db.alter_column(u'tracker_prizeticket', 'prize_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['donation_tracker.Prize']))

        # Changing field 'PrizeTicket.donation'
        db.alter_column(u'tracker_prizeticket', 'donation_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['donation_tracker.Donation']))

        # Changing field 'SpeedRun.event'
        db.alter_column(u'tracker_speedrun', 'event_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['donation_tracker.Event']))

        # Changing field 'Donation.event'
        db.alter_column(u'tracker_donation', 'event_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['donation_tracker.Event']))

        # Changing field 'Donation.donor'
        db.alter_column(u'tracker_donation', 'donor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['donation_tracker.Donor'], null=True))

        # Changing field 'PostbackURL.event'
        db.alter_column(u'tracker_postbackurl', 'event_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['donation_tracker.Event']))
    ...
    models = {
        ...
        'donation_tracker.bid': {
            ...
            'biddependency': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'depedent_bids'", 'null': 'True', 'on_delete': 'models.PROTECT', 'to': "orm['donation_tracker.Bid']"}),
            'count': ('django.db.models.fields.IntegerField', [], {}),
            'description': ('django.db.models.fields.TextField', [], {'max_length': '1024', 'blank': 'True'}),
            'event': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'bids'", 'null': 'True', 'on_delete': 'models.PROTECT', 'to': "orm['donation_tracker.Event']"}),
            ...
            'parent': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'related_name': "'options'", 'null': 'True', 'on_delete': 'models.PROTECT', 'to': "orm['donation_tracker.Bid']"}),
            'revealedtime': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'rght': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'speedrun': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'bids'", 'null': 'True', 'on_delete': 'models.PROTECT', 'to': "orm['donation_tracker.SpeedRun']"}),
        ...
        'donation_tracker.bidsuggestion': {
            ...
            'bid': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'suggestions'", 'on_delete': 'models.PROTECT', 'to': "orm['donation_tracker.Bid']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '64'})
        },
        'donation_tracker.donation': {
            ...
            'donor': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['donation_tracker.Donor']", 'null': 'True', 'on_delete': 'models.PROTECT', 'blank': 'True'}),
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['donation_tracker.Event']", 'on_delete': 'models.PROTECT'}),
        ...
        'donation_tracker.donationbid': {
            ...
            'bid': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'bids'", 'on_delete': 'models.PROTECT', 'to': "orm['donation_tracker.Bid']"}),
            'donation': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'bids'", 'on_delete': 'models.PROTECT', 'to': "orm['donation_tracker.Donation']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        ...
        'donation_tracker.donorcache': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['donation_tracker.Event']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        ...
        'donation_tracker.postbackurl': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'postbacks'", 'on_delete': 'models.PROTECT', 'to': "orm['donation_tracker.Event']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'donation_tracker.prize': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['donation_tracker.PrizeCategory']", 'null': 'True', 'on_delete': 'models.PROTECT', 'blank': 'True'}),
            ...
            'endrun': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'prize_end'", 'null': 'True', 'on_delete': 'models.PROTECT', 'to': "orm['donation_tracker.SpeedRun']"}),
            ...
            'startrun': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'prize_start'", 'null': 'True', 'on_delete': 'models.PROTECT', 'to': "orm['donation_tracker.SpeedRun']"}),
        ...
        'donation_tracker.prizeticket': {
            ...
            'amount': ('django.db.models.fields.DecimalField', [], {'max_digits': '20', 'decimal_places': '2'}),
            'donation': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tickets'", 'on_delete': 'models.PROTECT', 'to': "orm['donation_tracker.Donation']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'prize': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tickets'", 'on_delete': 'models.PROTECT', 'to': "orm['donation_tracker.Prize']"})
        },
        'donation_tracker.prizewinner': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'prize': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['donation_tracker.Prize']", 'on_delete': 'models.PROTECT'}),
            'winner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['donation_tracker.Donor']", 'on_delete': 'models.PROTECT'})
        },
