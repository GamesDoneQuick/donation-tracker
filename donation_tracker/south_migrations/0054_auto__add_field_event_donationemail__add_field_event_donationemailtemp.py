...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'tracker_event', 'donationemailtemplate',
        ...
        db.add_column(u'tracker_event', 'donationemailsender',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'tracker_event', 'donationemailtemplate_id')

        # Deleting field 'Event.donationemailsender'
        db.delete_column(u'tracker_event', 'donationemailsender')
    ...
    models = {
        ...
        'donation_tracker.donation': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['donation_tracker.Event']"}),
