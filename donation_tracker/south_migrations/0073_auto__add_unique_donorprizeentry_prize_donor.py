...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'DonorPrizeEntry', fields ['prize', 'donor']
        db.create_unique(u'tracker_donorprizeentry', ['prize_id', 'donor_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'DonorPrizeEntry', fields ['prize', 'donor']
        db.delete_unique(u'tracker_donorprizeentry', ['prize_id', 'donor_id'])
