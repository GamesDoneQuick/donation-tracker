...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.scheduletimezone'
        db.add_column(u'tracker_event', 'scheduletimezone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.scheduletimezone'
        db.delete_column(u'tracker_event', 'scheduletimezone')
    ...
    models = {
        ...
        u'donation_tracker.event': {
            ...
            'scheduletimezone': ('django.db.models.fields.CharField', [], {'max_length': '64', 'blank': 'True'}),
