...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'tracker_bid', 'biddependency',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='depedent_bids', null=True, blank=True, to=orm['donation_tracker.Bid']),
                      keep_default=False)
    ...
    models = {
        ...
        u'donation_tracker.bid': {
            ...
            'biddependency': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'depedent_bids'", 'null': 'True', 'blank': 'True', 'to': u"orm['donation_tracker.Bid']"}),
        ...
        u'donation_tracker.postbackurl': {
            'Meta': {'object_name': 'PostbackURL'},
            'event': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'postbacks'", 'to': u"orm['donation_tracker.Event']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
