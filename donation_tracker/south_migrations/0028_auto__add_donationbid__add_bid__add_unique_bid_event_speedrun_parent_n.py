...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tracker_donationbid', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('bid', self.gf('django.db.models.fields.related.ForeignKey')(related_name='bids', to=orm['donation_tracker.Bid'])),
            ('donation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='bids', to=orm['donation_tracker.Donation'])),
            ('amount', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=2)),
        ))
        db.send_create_signal(u'donation_tracker', ['DonationBid'])

        # Adding model 'Bid'
        db.create_table(u'tracker_bid', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='bids', null=True, to=orm['donation_tracker.Event'])),
            ('speedrun', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='bids', null=True, to=orm['donation_tracker.SpeedRun'])),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='options', null=True, to=orm['donation_tracker.Bid'])),
        ...
        db.send_create_signal(u'donation_tracker', ['Bid'])

        # Adding unique constraint on 'Bid', fields ['event', 'speedrun', 'parent', 'name']
        db.create_unique(u'tracker_bid', ['event_id', 'speedrun_id', 'parent_id', 'name'])

        # Deleting field 'Donor.issurrogate'
        db.delete_column(u'tracker_donor', 'issurrogate')


    def backwards(self, orm):
        # Removing unique constraint on 'Bid', fields ['event', 'speedrun', 'parent', 'name']
        db.delete_unique(u'tracker_bid', ['event_id', 'speedrun_id', 'parent_id', 'name'])

        # Deleting model 'DonationBid'
        db.delete_table(u'tracker_donationbid')

        # Deleting model 'Bid'
        db.delete_table(u'tracker_bid')

        # Adding field 'Donor.issurrogate'
        db.add_column(u'tracker_donor', 'issurrogate',
    ...
    models = {
        ...
        u'donation_tracker.challenge': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'speedrun': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['donation_tracker.SpeedRun']"}),
            'state': ('django.db.models.fields.CharField', [], {'default': "'OPENED'", 'max_length': '255'})
        },
        u'donation_tracker.challengebid': {
            'Meta': {'ordering': "['-donation__timereceived']", 'object_name': 'ChallengeBid'},
            'amount': ('django.db.models.fields.DecimalField', [], {'max_digits': '20', 'decimal_places': '2'}),
            'challenge': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'bids'", 'to': u"orm['donation_tracker.Challenge']"}),
            'donation': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['donation_tracker.Donation']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'donation_tracker.choice': {
        ...
        u'donation_tracker.choicebid': {
            'Meta': {'ordering': "['option__choice__speedrun__starttime', 'option__choice__name']", 'object_name': 'ChoiceBid'},
            'amount': ('django.db.models.fields.DecimalField', [], {'max_digits': '20', 'decimal_places': '2'}),
            'donation': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['donation_tracker.Donation']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'option': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'bids'", 'to': u"orm['donation_tracker.ChoiceOption']"})
        },
        u'donation_tracker.choiceoption': {
            'Meta': {'ordering': "['choice__speedrun__starttime', 'choice__name', 'name']", 'unique_together': "(('choice', 'name'),)", 'object_name': 'ChoiceOption'},
            'choice': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'option'", 'to': u"orm['donation_tracker.Choice']"}),
