...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PostbackURL'
        db.create_table(u'tracker_postbackurl', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(related_name='postbacks', to=orm['donation_tracker.Event'])),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
        ))
        db.send_create_signal(u'donation_tracker', ['PostbackURL'])


    def backwards(self, orm):
        # Deleting model 'PostbackURL'
        db.delete_table(u'tracker_postbackurl')
