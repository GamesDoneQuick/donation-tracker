...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Prize.sortkey'
        db.delete_column(u'tracker_prize', 'sortkey')

        # Deleting field 'SpeedRun.sortkey'
        db.delete_column(u'tracker_speedrun', 'sortkey')


    def backwards(self, orm):
        # Adding field 'Prize.sortkey'
        db.add_column(u'tracker_prize', 'sortkey',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'SpeedRun.sortkey'
        db.add_column(u'tracker_speedrun', 'sortkey',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True),
                      keep_default=False)
