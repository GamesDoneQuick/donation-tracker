...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Donor.email'
        db.alter_column(u'tracker_donor', 'email', self.gf('django.db.models.fields.EmailField')(max_length=128, unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'Donor.email'
        db.alter_column(u'tracker_donor', 'email', self.gf('django.db.models.fields.EmailField')(default=None, max_length=128, unique=True))
