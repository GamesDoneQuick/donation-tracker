...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PrizeWinner.shippingemailsent'
        db.add_column(u'tracker_prizewinner', 'shippingemailsent',
        ...
        # Adding field 'PrizeWinner.trackingnumber'
        db.add_column(u'tracker_prizewinner', 'trackingnumber',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'PrizeWinner.shippingstate'
        db.add_column(u'tracker_prizewinner', 'shippingstate',
                      self.gf('django.db.models.fields.CharField')(default='PENDING', max_length=64),
                      keep_default=False)

        # Adding field 'PrizeWinner.shippingcost'
        db.add_column(u'tracker_prizewinner', 'shippingcost',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=2, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'PrizeWinner.shippingemailsent'
        db.delete_column(u'tracker_prizewinner', 'shippingemailsent')

        # Deleting field 'PrizeWinner.acceptstate'
        db.delete_column(u'tracker_prizewinner', 'acceptstate')

        # Deleting field 'PrizeWinner.trackingnumber'
        db.delete_column(u'tracker_prizewinner', 'trackingnumber')

        # Deleting field 'PrizeWinner.shippingstate'
        db.delete_column(u'tracker_prizewinner', 'shippingstate')

        # Deleting field 'PrizeWinner.shippingcost'
        db.delete_column(u'tracker_prizewinner', 'shippingcost')
