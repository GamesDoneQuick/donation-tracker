...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DonorPrizeEntry'
        db.create_table(u'tracker_donorprizeentry', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('donor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['donation_tracker.Donor'], on_delete=models.PROTECT)),
            ('prize', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['donation_tracker.Prize'], on_delete=models.PROTECT)),
            ('weight', self.gf('django.db.models.fields.DecimalField')(default='1.0', max_digits=20, decimal_places=2)),
        ))
        db.send_create_signal('donation_tracker', ['DonorPrizeEntry'])


    def backwards(self, orm):
        # Deleting model 'DonorPrizeEntry'
        db.delete_table(u'tracker_donorprizeentry')
    ...
    models = {
        ...
        'donation_tracker.donorprizeentry': {
            'Meta': {'object_name': 'DonorPrizeEntry'},
