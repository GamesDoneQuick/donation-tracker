...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BidSuggestion'
        db.create_table(u'tracker_bidsuggestion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('bid', self.gf('django.db.models.fields.related.ForeignKey')(related_name='suggestions', to=orm['donation_tracker.Bid'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal(u'donation_tracker', ['BidSuggestion'])


    def backwards(self, orm):
        # Deleting model 'BidSuggestion'
        db.delete_table(u'tracker_bidsuggestion')
    ...
    models = {
        ...
        u'donation_tracker.bidsuggestion': {
            'Meta': {'object_name': 'BidSuggestion'},
