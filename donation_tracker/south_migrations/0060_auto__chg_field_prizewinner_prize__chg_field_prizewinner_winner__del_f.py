...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Event.donationemail'
        db.delete_column(u'tracker_event', 'donationemail')


        # Changing field 'Event.donationemailtemplate'
        db.alter_column(u'tracker_event', 'donationemailtemplate_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['post_office.EmailTemplate'], null=True, on_delete=models.PROTECT))
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Event.donationemail'
        db.add_column(u'tracker_event', 'donationemail',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Event.donationemailtemplate'
        db.alter_column(u'tracker_event', 'donationemailtemplate_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['post_office.EmailTemplate'], null=True))
