...
class Donation(models.Model):
  ...
  requestedvisibility = models.CharField(max_length=32, null=False, blank=False, default='ANON', choices=DonorVisibilityChoices, verbose_name='Requested Visibility');
