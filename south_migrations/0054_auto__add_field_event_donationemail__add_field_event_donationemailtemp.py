...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.donationemailtemplate'
        db.add_column('tracker_event', 'donationemailtemplate',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['post_office.EmailTemplate'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.donationemailsender'
        db.add_column('tracker_event', 'donationemailsender',
                      self.gf('django.db.models.fields.EmailField')(max_length=128, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Event.donationemailtemplate'
        db.delete_column('tracker_event', 'donationemailtemplate_id')

        # Deleting field 'Event.donationemailsender'
        db.delete_column('tracker_event', 'donationemailsender')
    ...
    models = {
        ...
        'tracker.donation': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['tracker.Event']"}),
