...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('tracker_event', 'donationemail')


        # Changing field 'Event.donationemailtemplate'
        db.alter_column('tracker_event', 'donationemailtemplate_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['post_office.EmailTemplate'], null=True, on_delete=models.PROTECT))
    ...
    def backwards(self, orm):
        ...
        db.add_column('tracker_event', 'donationemail',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Event.donationemailtemplate'
        db.alter_column('tracker_event', 'donationemailtemplate_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['post_office.EmailTemplate'], null=True))
    ...
    models = {
        ...
        'tracker.event': {
            ...
            'donationemailtemplate': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['post_office.EmailTemplate']", 'null': 'True', 'on_delete': 'models.PROTECT', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
