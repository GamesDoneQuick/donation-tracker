...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('tracker_prize', 'shortdescription')

        # Deleting field 'Bid.shortdescription'
        db.delete_column('tracker_bid', 'shortdescription')
