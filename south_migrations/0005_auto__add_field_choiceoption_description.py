...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChoiceOption.description'
        db.add_column('tracker_choiceoption', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ChoiceOption.description'
        db.delete_column('tracker_choiceoption', 'description')
