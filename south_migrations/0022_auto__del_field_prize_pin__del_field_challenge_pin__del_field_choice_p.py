...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('tracker_prize', 'pin')

        # Deleting field 'Challenge.pin'
        db.delete_column('tracker_challenge', 'pin')

        # Deleting field 'Choice.pin'
        db.delete_column('tracker_choice', 'pin')


    def backwards(self, orm):
        # Adding field 'Prize.pin'
        db.add_column('tracker_prize', 'pin',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Challenge.pin'
        db.add_column('tracker_challenge', 'pin',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Choice.pin'
        db.add_column('tracker_choice', 'pin',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
