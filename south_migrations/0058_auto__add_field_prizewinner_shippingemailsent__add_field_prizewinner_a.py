...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tracker_prizewinner', 'shippingemailsent',
        ...
        db.add_column('tracker_prizewinner', 'trackingnumber',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'PrizeWinner.shippingstate'
        db.add_column('tracker_prizewinner', 'shippingstate',
                      self.gf('django.db.models.fields.CharField')(default='PENDING', max_length=64),
                      keep_default=False)

        # Adding field 'PrizeWinner.shippingcost'
        db.add_column('tracker_prizewinner', 'shippingcost',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('tracker_prizewinner', 'shippingemailsent')
        ...
        db.delete_column('tracker_prizewinner', 'trackingnumber')

        # Deleting field 'PrizeWinner.shippingstate'
        db.delete_column('tracker_prizewinner', 'shippingstate')

        # Deleting field 'PrizeWinner.shippingcost'
        db.delete_column('tracker_prizewinner', 'shippingcost')
