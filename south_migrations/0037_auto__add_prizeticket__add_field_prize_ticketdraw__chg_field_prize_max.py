...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tracker_prizeticket', (
        ...
        db.send_create_signal('tracker', ['PrizeTicket'])

        # Adding field 'Prize.ticketdraw'
        db.add_column('tracker_prize', 'ticketdraw',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Prize.maximumbid'
        db.alter_column('tracker_prize', 'maximumbid', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=2))

    def backwards(self, orm):
        # Deleting model 'PrizeTicket'
        db.delete_table('tracker_prizeticket')

        # Deleting field 'Prize.ticketdraw'
        db.delete_column('tracker_prize', 'ticketdraw')


        # Changing field 'Prize.maximumbid'
        db.alter_column('tracker_prize', 'maximumbid', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=2))
