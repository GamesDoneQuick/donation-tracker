...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.send_create_signal(u'tracker', ['ChoiceBid'])
        ...
        db.send_create_signal(u'tracker', ['Challenge'])
        ...
        db.send_create_signal(u'tracker', ['ChoiceOption'])
        ...
        db.send_create_signal(u'tracker', ['Choice'])
        ...
        db.send_create_signal(u'tracker', ['ChallengeBid'])
