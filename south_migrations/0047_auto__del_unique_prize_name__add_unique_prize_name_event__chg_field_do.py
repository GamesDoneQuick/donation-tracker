...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('tracker_prize', ['name'])

        # Adding unique constraint on 'Prize', fields ['name', 'event']
        db.create_unique('tracker_prize', ['name', 'event_id'])


        # Changing field 'Donor.firstname'
        db.alter_column('tracker_donor', 'firstname', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Changing field 'Donor.lastname'
        db.alter_column('tracker_donor', 'lastname', self.gf('django.db.models.fields.CharField')(max_length=64))

    def backwards(self, orm):
        # Removing unique constraint on 'Prize', fields ['name', 'event']
        db.delete_unique('tracker_prize', ['name', 'event_id'])

        # Adding unique constraint on 'Prize', fields ['name']
        db.create_unique('tracker_prize', ['name'])


        # Changing field 'Donor.firstname'
        db.alter_column('tracker_donor', 'firstname', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'Donor.lastname'
        db.alter_column('tracker_donor', 'lastname', self.gf('django.db.models.fields.CharField')(max_length=32))
