...
description = """
A basic template for automailing back prize accept/reject notifications. DO NOT USE THIS TEMPLATE. Copy the contents and modify it to suit your needs.
...
defaultName = 'default_prize_contributor_notification'

class Migration(DataMigration):

  def forwards(self, orm):
    orm['post_office.EmailTemplate'].objects.create(name=defaultName, description=description, subject="Notification of Prize Submissions", content=content)
  ...
  models = {
      ...
      'post_office.attachment': {
          ...
          'emails': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'attachments'", 'symmetrical': 'False', 'to': "orm['post_office.Email']"}),
      ...
      'post_office.email': {
          ...
          'template': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['post_office.EmailTemplate']", 'null': 'True', 'blank': 'True'}),
