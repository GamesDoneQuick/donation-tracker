...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Event.sandbox'
        db.delete_column('tracker_event', 'sandbox')

        # Adding field 'Event.usepaypalsandbox'
        db.add_column('tracker_event', 'usepaypalsandbox',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Event.sandbox'
        db.add_column('tracker_event', 'sandbox',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Event.usepaypalsandbox'
        db.delete_column('tracker_event', 'usepaypalsandbox')
