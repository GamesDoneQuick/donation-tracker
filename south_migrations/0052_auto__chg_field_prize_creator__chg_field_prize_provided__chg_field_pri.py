...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Prize.creator'
        db.alter_column(u'tracker_prize', 'creator', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'Prize.provided'
        db.alter_column(u'tracker_prize', 'provided', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'Prize.creatoremail'
        db.alter_column(u'tracker_prize', 'creatoremail', self.gf('django.db.models.fields.EmailField')(max_length=128, null=True))

        # Changing field 'Prize.creatorwebsite'
        db.alter_column(u'tracker_prize', 'creatorwebsite', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'Prize.provideremail'
        db.alter_column(u'tracker_prize', 'provideremail', self.gf('django.db.models.fields.EmailField')(max_length=128, null=True))

    def backwards(self, orm):

        # Changing field 'Prize.creator'
        db.alter_column(u'tracker_prize', 'creator', self.gf('django.db.models.fields.CharField')(default='', max_length=64))

        # Changing field 'Prize.provided'
        db.alter_column(u'tracker_prize', 'provided', self.gf('django.db.models.fields.CharField')(default='', max_length=64))

        # Changing field 'Prize.creatoremail'
        db.alter_column(u'tracker_prize', 'creatoremail', self.gf('django.db.models.fields.EmailField')(default='', max_length=128))

        # Changing field 'Prize.creatorwebsite'
        db.alter_column(u'tracker_prize', 'creatorwebsite', self.gf('django.db.models.fields.CharField')(default='', max_length=128))

        # Changing field 'Prize.provideremail'
        db.alter_column(u'tracker_prize', 'provideremail', self.gf('django.db.models.fields.EmailField')(default='', max_length=128))
