...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('tracker_prizewinner', 'winner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Donor'], on_delete=models.PROTECT))

        # Changing field 'PrizeWinner.prize'
        db.alter_column('tracker_prizewinner', 'prize_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Prize'], on_delete=models.PROTECT))

        # Changing field 'DonationBid.donation'
        db.alter_column('tracker_donationbid', 'donation_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['tracker.Donation']))

        # Changing field 'DonationBid.bid'
        db.alter_column('tracker_donationbid', 'bid_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['tracker.Bid']))
        # Adding unique constraint on 'DonationBid', fields ['bid', 'donation']
        db.create_unique('tracker_donationbid', ['bid_id', 'donation_id'])

        # Changing field 'Prize.startrun'
        db.alter_column('tracker_prize', 'startrun_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['tracker.SpeedRun']))

        # Changing field 'Prize.category'
        db.alter_column('tracker_prize', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.PrizeCategory'], null=True, on_delete=models.PROTECT))

        # Changing field 'Prize.event'
        db.alter_column('tracker_prize', 'event_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Event'], on_delete=models.PROTECT))

        # Changing field 'Prize.endrun'
        db.alter_column('tracker_prize', 'endrun_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['tracker.SpeedRun']))

        # Changing field 'BidSuggestion.bid'
        db.alter_column('tracker_bidsuggestion', 'bid_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['tracker.Bid']))

        # Changing field 'Bid.parent'
        db.alter_column('tracker_bid', 'parent_id', self.gf('mptt.fields.TreeForeignKey')(null=True, on_delete=models.PROTECT, to=orm['tracker.Bid']))

        # Changing field 'Bid.biddependency'
        db.alter_column('tracker_bid', 'biddependency_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['tracker.Bid']))

        # Changing field 'Bid.speedrun'
        db.alter_column('tracker_bid', 'speedrun_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['tracker.SpeedRun']))

        # Changing field 'Bid.event'
        db.alter_column('tracker_bid', 'event_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['tracker.Event']))

        # Changing field 'PrizeTicket.prize'
        db.alter_column('tracker_prizeticket', 'prize_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['tracker.Prize']))

        # Changing field 'PrizeTicket.donation'
        db.alter_column('tracker_prizeticket', 'donation_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['tracker.Donation']))

        # Changing field 'SpeedRun.event'
        db.alter_column('tracker_speedrun', 'event_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Event'], on_delete=models.PROTECT))

        # Changing field 'Donation.event'
        db.alter_column('tracker_donation', 'event_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Event'], on_delete=models.PROTECT))

        # Changing field 'Donation.donor'
        db.alter_column('tracker_donation', 'donor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Donor'], null=True, on_delete=models.PROTECT))

        # Changing field 'PostbackURL.event'
        db.alter_column('tracker_postbackurl', 'event_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['tracker.Event']))

    def backwards(self, orm):
        # Removing unique constraint on 'DonationBid', fields ['bid', 'donation']
        db.delete_unique('tracker_donationbid', ['bid_id', 'donation_id'])


        # Changing field 'PrizeWinner.winner'
        db.alter_column('tracker_prizewinner', 'winner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Donor']))

        # Changing field 'PrizeWinner.prize'
        db.alter_column('tracker_prizewinner', 'prize_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Prize']))

        # Changing field 'DonationBid.donation'
        db.alter_column('tracker_donationbid', 'donation_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Donation']))

        # Changing field 'DonationBid.bid'
        db.alter_column('tracker_donationbid', 'bid_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Bid']))

        # Changing field 'Prize.startrun'
        db.alter_column('tracker_prize', 'startrun_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['tracker.SpeedRun']))

        # Changing field 'Prize.category'
        db.alter_column('tracker_prize', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.PrizeCategory'], null=True))

        # Changing field 'Prize.event'
        db.alter_column('tracker_prize', 'event_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Event']))

        # Changing field 'Prize.endrun'
        db.alter_column('tracker_prize', 'endrun_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['tracker.SpeedRun']))

        # Changing field 'BidSuggestion.bid'
        db.alter_column('tracker_bidsuggestion', 'bid_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Bid']))

        # Changing field 'Bid.parent'
        db.alter_column('tracker_bid', 'parent_id', self.gf('mptt.fields.TreeForeignKey')(null=True, to=orm['tracker.Bid']))

        # Changing field 'Bid.biddependency'
        db.alter_column('tracker_bid', 'biddependency_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['tracker.Bid']))

        # Changing field 'Bid.speedrun'
        db.alter_column('tracker_bid', 'speedrun_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['tracker.SpeedRun']))

        # Changing field 'Bid.event'
        db.alter_column('tracker_bid', 'event_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['tracker.Event']))

        # Changing field 'PrizeTicket.prize'
        db.alter_column('tracker_prizeticket', 'prize_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Prize']))

        # Changing field 'PrizeTicket.donation'
        db.alter_column('tracker_prizeticket', 'donation_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Donation']))

        # Changing field 'SpeedRun.event'
        db.alter_column('tracker_speedrun', 'event_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Event']))

        # Changing field 'Donation.event'
        db.alter_column('tracker_donation', 'event_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Event']))

        # Changing field 'Donation.donor'
        db.alter_column('tracker_donation', 'donor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Donor'], null=True))

        # Changing field 'PostbackURL.event'
        db.alter_column('tracker_postbackurl', 'event_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Event']))
    ...
    models = {
        ...
        'tracker.event': {
            ...
            'donationemailtemplate': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['post_office.EmailTemplate']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
