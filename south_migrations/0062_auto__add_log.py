...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Log'
        db.create_table('tracker_log', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('category', self.gf('django.db.models.fields.CharField')(default='other', max_length=64)),
            ('message', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Event'], null=True, on_delete=models.PROTECT, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
        ))
        db.send_create_signal('tracker', ['Log'])


    def backwards(self, orm):
        # Deleting model 'Log'
        db.delete_table('tracker_log')
