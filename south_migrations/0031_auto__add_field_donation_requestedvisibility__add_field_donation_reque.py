...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('tracker_donation', 'requestedvisibility')

        # Deleting field 'Donation.requestedalias'
        db.delete_column('tracker_donation', 'requestedalias')

        # Deleting field 'Donation.requestedemail'
        db.delete_column('tracker_donation', 'requestedemail')
