...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tracker_event', 'prizemailsubject',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128),
                      keep_default=False)

        # Adding field 'Event.prizemailbody'
        db.add_column('tracker_event', 'prizemailbody',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('tracker_event', 'prizemailsubject')

        # Deleting field 'Event.prizemailbody'
        db.delete_column('tracker_event', 'prizemailbody')
    ...
    models = {
        ...
        'tracker.bid': {
            ...
            'biddependency': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'depedent_bids'", 'null': 'True', 'blank': 'True', 'to': "orm['tracker.Bid']"}),
