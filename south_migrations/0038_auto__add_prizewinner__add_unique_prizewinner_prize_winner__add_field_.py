...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tracker_prizewinner', (
        ...
        db.send_create_signal('tracker', ['PrizeWinner'])

        # Adding unique constraint on 'PrizeWinner', fields ['prize', 'winner']
        db.create_unique('tracker_prizewinner', ['prize_id', 'winner_id'])

        # Adding field 'Prize.maxwinners'
        db.add_column('tracker_prize', 'maxwinners',
    ...
    def backwards(self, orm):
        ...
        db.delete_unique('tracker_prizewinner', ['prize_id', 'winner_id'])

        # Deleting model 'PrizeWinner'
        db.delete_table('tracker_prizewinner')

        # Deleting field 'Prize.maxwinners'
        db.delete_column('tracker_prize', 'maxwinners')
