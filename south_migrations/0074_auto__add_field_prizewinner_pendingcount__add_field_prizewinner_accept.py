...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tracker_prizewinner', 'pendingcount',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'PrizeWinner.acceptcount'
        db.add_column('tracker_prizewinner', 'acceptcount',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PrizeWinner.declinecount'
        db.add_column('tracker_prizewinner', 'declinecount',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PrizeWinner.sumcount'
        db.add_column('tracker_prizewinner', 'sumcount',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Prize.maxmultiwin'
        db.add_column('tracker_prize', 'maxmultiwin',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('tracker_prizewinner', 'pendingcount')

        # Deleting field 'PrizeWinner.acceptcount'
        db.delete_column('tracker_prizewinner', 'acceptcount')

        # Deleting field 'PrizeWinner.declinecount'
        db.delete_column('tracker_prizewinner', 'declinecount')

        # Deleting field 'PrizeWinner.sumcount'
        db.delete_column('tracker_prizewinner', 'sumcount')

        # Deleting field 'Prize.maxmultiwin'
        db.delete_column('tracker_prize', 'maxmultiwin')
