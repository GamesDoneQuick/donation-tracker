...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tracker_prize', 'provideremail',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=128, blank=True),
                      keep_default=False)

        # Adding field 'Prize.acceptemailsent'
        db.add_column('tracker_prize', 'acceptemailsent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Prize.creatorwebsite'
        db.alter_column('tracker_prize', 'creatorwebsite', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'Prize.creatoremail'
        db.alter_column('tracker_prize', 'creatoremail', self.gf('django.db.models.fields.EmailField')(max_length=128))

    def backwards(self, orm):
        # Deleting field 'Prize.extrainfo'
        db.delete_column('tracker_prize', 'extrainfo')

        # Deleting field 'Prize.estimatedvalue'
        db.delete_column('tracker_prize', 'estimatedvalue')

        # Deleting field 'Prize.provideremail'
        db.delete_column('tracker_prize', 'provideremail')

        # Deleting field 'Prize.acceptemailsent'
        db.delete_column('tracker_prize', 'acceptemailsent')


        # Changing field 'Prize.creatorwebsite'
        db.alter_column('tracker_prize', 'creatorwebsite', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Changing field 'Prize.creatoremail'
        db.alter_column('tracker_prize', 'creatoremail', self.gf('django.db.models.fields.CharField')(max_length=64))
