...
defaultName = 'default_prize_winner_template'

description = """
A basic template for automailing prize winners. DO NOT USE THIS TEMPLATE. Copy the contents and modify it to suit your needs.
...
class Migration(DataMigration):
  ...
  def forwards(self, orm):
    orm['post_office.EmailTemplate'].objects.create(name=defaultName, description=description, subject="You Won a Prize during {{ event.name }}", content=content)
