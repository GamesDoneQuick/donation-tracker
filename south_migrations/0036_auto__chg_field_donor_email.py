...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('tracker_donor', 'email', self.gf('django.db.models.fields.EmailField')(default='thepreviousmigrationwillensurethisdoesntgetused@yahoo.com', unique=True, max_length=128))

    def backwards(self, orm):

        # Changing field 'Donor.email'
        db.alter_column('tracker_donor', 'email', self.gf('django.db.models.fields.EmailField')(unique=True, max_length=128, null=True))
