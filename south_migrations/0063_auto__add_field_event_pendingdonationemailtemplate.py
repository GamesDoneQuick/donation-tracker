...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tracker_event', 'pendingdonationemailtemplate',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('tracker_event', 'pendingdonationemailtemplate_id')
    ...
    models = {
        ...
        'tracker.event': {
            ...
            'pendingdonationemailtemplate': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['post_office.EmailTemplate']", 'null': 'True', 'on_delete': 'models.PROTECT', 'blank': 'True'}),
