...
urlpatterns = [
    ...
    path('bid/<int:pk>', public.bid, name='bid'),
    path('donors/<slug:event>', public.donorindex, name='donorindex'),
    path('donor/<int:pk>', public.donor, name='donor'),
    path('donor/<int:pk>/<slug:event>', public.donor, name='donor'),
    path('donations/<slug:event>', public.donationindex, name='donationindex'),
    path('donation/<int:pk>', public.donation, name='donation'),
    path('runs/<slug:event>', public.runindex, name='runindex'),
    path('run/<int:pk>', public.run, name='run'),
    path('prizes/<slug:event>', public.prizeindex, name='prizeindex'),
    path('prize/<int:pk>', public.prize, name='prize'),
