...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Donation.requestedvisibility'
        db.add_column(u'tracker_donation', 'requestedvisibility',
                      self.gf('django.db.models.fields.CharField')(default='ANON', max_length=32),
                      keep_default=False)

        # Adding field 'Donation.requestedalias'
        db.add_column(u'tracker_donation', 'requestedalias',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Donation.requestedemail'
        db.add_column(u'tracker_donation', 'requestedemail',
                      self.gf('django.db.models.fields.EmailField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Donation.requestedvisibility'
        db.delete_column(u'tracker_donation', 'requestedvisibility')

        # Deleting field 'Donation.requestedalias'
        db.delete_column(u'tracker_donation', 'requestedalias')

        # Deleting field 'Donation.requestedemail'
        db.delete_column(u'tracker_donation', 'requestedemail')
    ...
    models = {
        ...
        u'tracker.donation': {
            ...
            'requestedvisibility': ('django.db.models.fields.CharField', [], {'default': "'ANON'", 'max_length': '32'}),
