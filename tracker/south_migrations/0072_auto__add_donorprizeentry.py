...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tracker_donorprizeentry', (
            ...
            ('donor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Donor'], on_delete=models.PROTECT)),
            ('prize', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Prize'], on_delete=models.PROTECT)),
            ('weight', self.gf('django.db.models.fields.DecimalField')(default='1.0', max_digits=20, decimal_places=2)),
        ))
        db.send_create_signal('tracker', ['DonorPrizeEntry'])
