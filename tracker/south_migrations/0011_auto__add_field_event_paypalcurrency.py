...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.paypalcurrency'
        db.add_column('tracker_event', 'paypalcurrency',
                      self.gf('django.db.models.fields.CharField')(default='USD', max_length=8),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.paypalcurrency'
        db.delete_column('tracker_event', 'paypalcurrency')
