...
NO_CHANGES = _('Requested change is a no-op.')
NO_CHANGES_CODE = 'noop'
SAME_EVENT = _('Objects must belong to the same event.')
SAME_EVENT_CODE = 'same_event'
UNORDERED_RUN = _('Requested operation requires referenced run to be ordered.')
UNORDERED_RUN_CODE = 'unordered_run'
ANCHORED_RUN_IMMOVABLE = _('Cannot move an anchored run')
ANCHORED_RUN_IMMOVABLE_CODE = 'anchored_run_immovable'
ANCHORED_RUN_BEFORE = _('Cannot move a run directly before an anchored run')
ANCHORED_RUN_BEFORE_CODE = 'anchored_run_before'
INVALID_ORDER = _('Order must be a positive integer, null, or the string `last`.')
