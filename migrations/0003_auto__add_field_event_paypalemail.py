...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.paypalemail'
        db.add_column('tracker_event', 'paypalemail',
                      self.gf('django.db.models.fields.EmailField')(default='prevent@preventcancer.org', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.paypalemail'
        db.delete_column('tracker_event', 'paypalemail')
