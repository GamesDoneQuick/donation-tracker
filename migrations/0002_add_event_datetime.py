...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='speedrun',
            name='order',
            field=models.IntegerField(help_text=b'Please note that using the schedule editor is much easier', blank=True, null=True, validators=[tracker.validators.positive]),
        ),
    ]
