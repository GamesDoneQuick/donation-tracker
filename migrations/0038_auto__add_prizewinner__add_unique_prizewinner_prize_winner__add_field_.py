...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tracker_prizewinner', (
            ...
            ('winner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Donor'])),
            ('prize', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Prize'])),
            ('emailsent', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'tracker', ['PrizeWinner'])
