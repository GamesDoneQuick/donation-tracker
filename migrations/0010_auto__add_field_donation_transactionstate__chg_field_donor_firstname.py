...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Donation.transactionstate'
        db.add_column('tracker_donation', 'transactionstate',
                      self.gf('django.db.models.fields.CharField')(default='PENDING', max_length=64),
                      keep_default=False)


        # Changing field 'Donor.firstname'
        db.alter_column('tracker_donor', 'firstname', self.gf('django.db.models.fields.CharField')(default='', max_length=32))

    def backwards(self, orm):
        # Deleting field 'Donation.transactionstate'
        db.delete_column('tracker_donation', 'transactionstate')


        # Changing field 'Donor.firstname'
        db.alter_column('tracker_donor', 'firstname', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))
