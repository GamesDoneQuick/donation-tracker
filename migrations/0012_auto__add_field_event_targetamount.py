...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.targetamount'
        db.add_column('tracker_event', 'targetamount',
                      self.gf('django.db.models.fields.DecimalField')(default=100.0, max_digits=20, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.targetamount'
        db.delete_column('tracker_event', 'targetamount')
