...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RemoveField(model_name="credentialsmodel", name="id",),
        migrations.RemoveField(model_name="flowmodel", name="id",),
        ...
        migrations.DeleteModel(name="CredentialsModel",),
        migrations.DeleteModel(name="FlowModel",),
    ]
