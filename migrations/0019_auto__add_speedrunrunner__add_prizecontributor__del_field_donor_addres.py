...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SpeedRunRunner'
        db.create_table('tracker_speedrunrunner', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('runner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Donor'])),
            ('run', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.SpeedRun'])),
        ))
        db.send_create_signal('tracker', ['SpeedRunRunner'])

        # Adding model 'PrizeContributor'
        db.create_table('tracker_prizecontributor', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('contributor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Donor'])),
            ('prize', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Prize'])),
        ))
        db.send_create_signal('tracker', ['PrizeContributor'])
    ...
    def backwards(self, orm):
        # Deleting model 'SpeedRunRunner'
        db.delete_table('tracker_speedrunrunner')

        # Deleting model 'PrizeContributor'
        db.delete_table('tracker_prizecontributor')
